...
namespace RexonaAU.Helpers
{
    public class GoogleAnalyticsAPI
    {
        ...
        {
            //LogHelper.Info(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType, "Key path - " + keyPath);

            try
            {
                var certificate = new X509Certificate2(keyPath, "notasecret", X509KeyStorageFlags.MachineKeySet |
            ...
            {
                LogHelper.Error(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType, "Rexona AUS : GoogleAnalyticsAPI() method:" + Environment.NewLine + "Message: " + ex.Message + Environment.NewLine + "Stack Trace: " + ex.StackTrace, ex);
            }
        }
